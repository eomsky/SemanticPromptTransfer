# semantic-prompt-transfer 0.26.6

SemanticPromptTransfer v0.26.6 is a time-boxed Colab POC implementation for the
...
The v0.26.6 notebook runs the API in anonymous POC mode. The packaged server still
...
v0.26.6 is suitable for a scheduled single-Colab POC. It is not yet a production
