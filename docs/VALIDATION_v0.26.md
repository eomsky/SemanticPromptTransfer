# SemanticPromptTransfer v0.26 검증 기록

검증일: 2026-08-31

## 완료한 검증

- Python 단위·통합 테스트 38개 통과
- v0.26 노트북의 모든 Python 코드 셀 컴파일 통과
...
- v0.26 wheel 내부에 수정된 HTML, 근거 캡처, 첨부자료 처리 코드와 버전
  `0.26.0`이 포함됨을 확인
- v0.25와 v0.26의 wheel 경로·manifest·SHA-256이 서로 독립적임을 확인

## 산출물 무결성

| 산출물 | 크기 | SHA-256 |
|---|---:|---|
| `semantic_prompt_transfer-0.26.0-py3-none-any.whl` | 176,207 | `f4c68ea006913a37ea3248dece6e55c099e67d5b106ded9b4ecab8fcefc6ada1` |
| `SemanticPromptTransfer_v0.26_COLAB_LAUNCHER.ipynb` | 42,749 | `47d0c120b0105f54373cadeb8ef190f065607796bd3e4ba8f35045f5ab38355a` |
